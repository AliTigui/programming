/* kotlin Intro and basic
* kotlin file end with .kt
* kotlin programme file have main functoin that have all code that we want execut
* for make line comment we use //
* for make multiple line comment we use /* */
* in kotlin we can make multiple line comment inside in other one
